...
const Hero = () => {
    return (
        <div className='mt-10 max-w-[1400px] mx-2 lg:mx-auto flex flex-col lg:flex-row  justify-between mb-10 items-center gap-5'>
            <div className='relative justify-center grid gap-y-3 text-center text-white bg-gradient-to-r from-[#632EE3] to-[#9F62F2] px-75 py-20 rounded-xl'>
            ...
            <div className='relative justify-center grid gap-y-3 text-center text-white bg-gradient-to-r from-[#54CF68] to-[#00827A] px-75 py-20 rounded-xl'>
                <img src={heroImg} alt="" className='absolute  bottom-0'/>
                <img src={HeroImg} alt="" className='absolute bottom-0 right-0' />
